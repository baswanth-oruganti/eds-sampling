### The folowing scripts are used to sample a path for performing metadynamics simulations from a previously run EDS sampling using GROMACS. Scripts are to be executed in the following order
